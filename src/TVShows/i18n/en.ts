export const tvEn = {
    ...
    errors: {
      show: 'Failed to load this show.',
      season: 'Failed to load this season.',
    },
    empty: {
      selectSeason: 'Select a season to view episodes.',
    ...
    progress: {
        season: '{{watched}} of {{total}} watched',
        show: '{{watched}} of {{total}} episodes watched',
        markAll: 'Mark all',
